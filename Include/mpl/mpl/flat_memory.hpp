...
namespace detail {
    ...
    template <typename T, typename I> class flat_memory_in {
    public:
    ...
    template <typename T> class flat_memory_in<T, T*> {
    public:
        typedef std::ptrdiff_t size_type;
    ...
    template <typename T> class flat_memory_in<T, typename std::vector<T>::iterator> {
    public:
        typedef std::ptrdiff_t size_type;
    ...
    template <typename T> class flat_memory_in<T, typename std::vector<T>::const_iterator> {
    public:
        typedef std::ptrdiff_t size_type;
    ...
    template <typename T, typename I> class flat_memory_out {
    public:
        typedef std::ptrdiff_t size_type;
    ...
    public:
        ...
        I copy_back(size_type m) const { return std::copy(first, first + std::min(m, n), first_out); }
    };

    template <typename T> class flat_memory_out<T, T*> {
    public:
        typedef std::ptrdiff_t size_type;
    ...
    // a more general implementation would be possible with
    // contiguous_iterator_tag of C++17
    template <typename T> class flat_memory_out<T, typename std::vector<T>::iterator> {
    public:
        typedef std::ptrdiff_t size_type;

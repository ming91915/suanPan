...
extern "C" {
void arma_fortran(arma_dgbmv)(char* TRANS,
    int* M,
    int* N,
    int* KL,
    int* KU,
...
void arma_fortran(arma_dsymv)(char* UPLO,
    int* N,
    double* ALPHA,
    double* A,
    int* LDA,
...
void arma_fortran(arma_dsbmv)(char* UPLO,
    int* N,
    int* K,
    double* ALPHA,
    double* A,
...
void arma_fortran(arma_sspmv)(char* UPLO,
    int* N,
    float* ALPHA,
    float* AP,
    float* X,
...
void arma_fortran(arma_dspmv)(char* UPLO,
    int* N,
    double* ALPHA,
    double* AP,
    double* X,
...
void arma_fortran(arma_dgetri)(int* N,
    double* A,
    int* LDA,
    int* IPIV,
    double* WORK,
...
void arma_fortran(arma_dgbsv)(int* N,
    int* KL,
    int* KU,
    int* NRHS,
    double* AB,
...
void arma_fortran(arma_dsysv)(char* UPLO,
    int* N,
    int* NRHS,
    double* A,
    int* LDA,
...
void arma_fortran(arma_dposv)(char* UPLO,
    int* N,
    int* NRHS,
    double* A,
    int* LDA,
...
void arma_fortran(arma_dpbsv)(char* UPLO,
    int* N,
    int* KD,
    int* NRHS,
    double* AB,
...
void arma_fortran(arma_dsygvx)(int* ITYPE,
    char* JOBZ,
    char* RANGE,
    char* UPLO,
    int* N,
...
void arma_fortran(arma_sspsv)(char* UPLO,
    int* N,
    int* NRHS,
    float* AP,
    int* IPIV,
...
void arma_fortran(arma_dspsv)(char* UPLO,
    int* N,
    int* NRHS,
    double* AP,
    int* IPIV,
...
void arma_fortran(
    arma_ssptri)(char* UPLO, int* N, float* AP, int* IPIV, float* WORK, int* INFO);

void arma_fortran(
    arma_dsptri)(char* UPLO, int* N, double* AP, int* IPIV, double* WORK, int* INFO);
}

...
typename enable_if2<is_SymmMat<T1>::value && is_Mat<T2>::value &&
...
template <typename T1, typename T2>
typename enable_if2<is_Mat<T1>::value && is_SymmMat<T2>::value &&
        is_same_type<typename T1::elem_type, typename T2::elem_type>::value,
    const Glue<T1, T2, glue_times_symm>>::result
operator*(const T1& X, const T2& Y)
{
...
inline typename enable_if2<
    (is_SymmMat<T1>::value && is_arma_type<T2>::value &&
...
template <typename T1, typename T2>
inline typename enable_if2<
    (is_arma_type<T1>::value && is_SymmMat<T2>::value &&
        (is_same_type<typename T1::elem_type, typename T2::elem_type>::no)),
    const mtGlue<
        typename promote_type<typename T1::elem_type, typename T2::elem_type>::result,
        T1,

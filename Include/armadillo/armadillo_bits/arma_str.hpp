...
inline int arma_snprintf(char* out, size_t size, const char* fmt, ...)
{
    size_t i;

    for(i = 0; i < size; ++i) {
        out[i] = fmt[i];
        if(fmt[i] == char(0)) break;
    }

    if(size > 0) out[size - 1] = char(0);
...
inline std::string str(const basic_format<basic_format<format, T2>, T3>& X)
{
    ...
    do {
        ...
        required_size =
            arma_snprintf(buffer, size_t(buffer_size), X.A.A.A.c_str(), X.A.B, X.B);
    ...
    const basic_format<basic_format<basic_format<format, T2>, T3>, T4>& X)
{
    ...
    do {
        ...
        required_size = arma_snprintf(
            buffer, size_t(buffer_size), X.A.A.A.A.c_str(), X.A.A.B, X.A.B, X.B);
        ...
        X)
{
    ...
    do {
        ...
        required_size = arma_snprintf(buffer, size_t(buffer_size), X.A.A.A.A.A.c_str(),
...
inline std::string str(const basic_format<
    ...
    T6>& X)
{
    ...
    do {
        ...
        required_size = arma_snprintf(buffer, size_t(buffer_size), X.A.A.A.A.A.A.c_str(),
    ...
    T7>& X)
{
    ...
    do {
        ...
        required_size =
            arma_snprintf(buffer, size_t(buffer_size), X.A.A.A.A.A.A.A.c_str(),
...
inline static const T1& str_wrapper(const T1& x,
...
template <typename T1>
inline static std::string str_wrapper(const T1& x,

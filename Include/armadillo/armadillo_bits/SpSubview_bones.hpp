...
class SpSubview_col : public SpSubview<eT>
  ...
  inline SpSubview_col(const Mat<eT>& in_m, const uword in_col, const uword in_row1, const
uword in_n_rows);
  inline SpSubview_col(      Mat<eT>& in_m, const uword in_col, const uword in_row1, const
uword in_n_rows);
...
class SpSubview_row : public SpSubview<eT>
  ...
  inline SpSubview_row(const Mat<eT>& in_m, const uword in_row, const uword in_col1, const
uword in_n_cols);
  inline SpSubview_row(      Mat<eT>& in_m, const uword in_row, const uword in_col1, const
uword in_n_cols);

...
public:
    ...
    inline explicit field(const uword n_rows_in,
    ...
    inline void
    set_size(const uword n_rows_in, const uword n_cols_in, const uword n_slices_in);
    ...
    inline subview_field<oT> subfield(const uword in_row1,
        const uword in_col1,
        const uword in_row2,
        const uword in_col2);
    ...
    subfield(const uword in_row1, const uword in_col1, const SizeMat& s);
    ...
    inline subview_field<oT>
    subfield(const span& row_span, const span& col_span, const span& slice_span);
    inline const subview_field<oT>
    subfield(const span& row_span, const span& col_span, const span& slice_span) const;
    ...
    inline subview_field<oT> operator()(const uword in_row1,
        const uword in_col1,
        const uword in_slice1,
        const SizeCube& s);
...
private:
    ...
    inline void
    init(const uword n_rows_in, const uword n_cols_in, const uword n_slices_in);
...
public:
    ...
    inline static bool save(const field<oT>& x,
    ...
    inline static bool save(const field<oT>& x,
        ...
        std::string& err_msg);
    template <typename oT>
    inline static bool load(field<oT>& x,
        const std::string& name,
        const file_type type,
        std::string& err_msg);
    template <typename oT>
    ...
    inline static bool save(const field<std::string>& x,
        const std::string& name,
        const file_type type,
        std::string& err_msg);
    inline static bool save(const field<std::string>& x,
        ...
        const file_type type,
        std::string& err_msg);
    inline static bool load(field<std::string>& x,
        const std::string& name,
        const file_type type,
        std::string& err_msg);
    inline static bool load(field<std::string>& x,

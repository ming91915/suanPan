...
arma_hot inline void glue_times_redirect2_helper<do_inv_detect>::apply(
...
template <typename T1, typename T2>
arma_hot inline void glue_times_redirect2_helper<true>::apply(
    Mat<typename T1::elem_type>& out,
    const Glue<T1, T2, glue_times>& X)
{
    arma_extra_debug_sigprint();
    ...
    if(strip_inv<T1>::do_inv == true) {
        ...
        arma_debug_check(
            (A.is_square() == false), "inv(): given matrix must be square sized");
...
arma_hot inline void glue_times_redirect3_helper<do_inv_detect>::apply(
    Mat<typename T1::elem_type>& out,
...
template <typename T1, typename T2, typename T3>
arma_hot inline void glue_times_redirect3_helper<true>::apply(
    Mat<typename T1::elem_type>& out,
    const Glue<Glue<T1, T2, glue_times>, T3, glue_times>& X)
{
    arma_extra_debug_sigprint();
    ...
    if(strip_inv<T2>::do_inv == true) {
        ...
        arma_debug_check(
            (B.is_square() == false), "inv(): given matrix must be square sized");
...
template <uword N>
template <typename T1, typename T2>
arma_hot inline void glue_times_redirect<N>::apply(Mat<typename T1::elem_type>& out,
    const Glue<T1, T2, glue_times>& X)
{
    arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
arma_hot inline void glue_times_redirect<2>::apply(Mat<typename T1::elem_type>& out,
    const Glue<T1, T2, glue_times>& X)
{
    arma_extra_debug_sigprint();
...
template <typename T1, typename T2, typename T3>
arma_hot inline void glue_times_redirect<3>::apply(Mat<typename T1::elem_type>& out,
    const Glue<Glue<T1, T2, glue_times>, T3, glue_times>& X)
{
    arma_extra_debug_sigprint();
...
arma_hot inline void glue_times_redirect<4>::apply(Mat<typename T1::elem_type>& out,
...
template <typename T1, typename T2>
arma_hot inline void glue_times::apply(Mat<typename T1::elem_type>& out,
    const Glue<T1, T2, glue_times>& X)
{
    arma_extra_debug_sigprint();
...
arma_hot inline void glue_times::apply_inplace(Mat<typename T1::elem_type>& out,
    const T1& X)
{
    arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
arma_hot inline void glue_times::apply_inplace_plus(Mat<typename T1::elem_type>& out,
    const Glue<T1, T2, glue_times>& X,
    const sword sign)
{
    arma_extra_debug_sigprint();
    ...
    const eT alpha = use_alpha ?
        (tmp1.get_val() * tmp2.get_val() * ((sign > sword(0)) ? eT(1) : eT(-1))) :
        eT(0);
...
glue_times::apply(Mat<eT>& out, const TA& A, const TB& B, const eT alpha)
{
    arma_extra_debug_sigprint();
...
template <typename eT,
    ...
    typename TC>
arma_hot inline void
glue_times::apply(Mat<eT>& out, const TA& A, const TB& B, const TC& C, const eT alpha)
{
    arma_extra_debug_sigprint();
...
template <typename eT,
    ...
    typename TC,
    typename TD>
arma_hot inline void glue_times::apply(Mat<eT>& out,
    const TA& A,
    const TB& B,
    const TC& C,
    const TD& D,
...
template <typename T1, typename T2>
arma_hot inline void glue_times_diag::apply(Mat<typename T1::elem_type>& out,

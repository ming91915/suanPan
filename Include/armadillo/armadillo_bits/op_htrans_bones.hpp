...
public:
    ...
    arma_hot arma_inline static void apply_mat_noalias(Mat<eT>& out,
        const Mat<eT>& A,
        const typename arma_not_cx<eT>::result* junk = 0);

    template <typename eT>
    arma_hot inline static void apply_mat_noalias(Mat<eT>& out,
        const Mat<eT>& A,
    ...
    template <typename eT>
    arma_hot arma_inline static void apply_mat_inplace(Mat<eT>& out,
        const typename arma_not_cx<eT>::result* junk = 0);
    ...
    template <typename eT>
    arma_hot arma_inline static void apply_mat(Mat<eT>& out,
        const Mat<eT>& A,
        const typename arma_not_cx<eT>::result* junk = 0);

    template <typename eT>
    arma_hot inline static void apply_mat(Mat<eT>& out,
        const Mat<eT>& A,
        const typename arma_cx_only<eT>::result* junk = 0);
...
public:
    ...
    apply_noalias(Mat<eT>& out, const Mat<eT>& A, const eT val);

        ...
        )
{
    ...
    // arma_debug_warn("inv(X,char*) is deprecated and will be removed; change to
    // inv(X)");
        ...
        )
{
    ...
    // arma_debug_warn("inv(Y,X,bool) is deprecated and will be removed; change to
    // inv(Y,X)");
        ...
        )
{
    ...
    // arma_debug_warn("inv(Y,X,char*) is deprecated and will be removed; change to
    // inv(Y,X)");
        ...
        )
{
    ...
    // arma_debug_warn("inv_sympd(X,bool) is deprecated and will be removed; change to
    // inv_sympd(X)");
        ...
        )
{
    ...
    // arma_debug_warn("inv_sympd(X,char*) is deprecated and will be removed; change to
    // inv_sympd(X)");
        ...
        )
{
    ...
    // arma_debug_warn("inv_sympd(Y,X,bool) is deprecated and will be removed; change to
    // inv_sympd(Y,X)");
        ...
        )
{
    ...
    // arma_debug_warn("inv_sympd(Y,X,char*) is deprecated and will be removed; change to
    // inv_sympd(Y,X)");

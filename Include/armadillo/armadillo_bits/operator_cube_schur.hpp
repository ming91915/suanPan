...
template <typename T1, typename T2> arma_inline const eGlueCube<T1, T2, eglue_schur> operator%(const BaseCube<typename T1::elem_type, T1>& X, const BaseCube<typename T1::elem_type, T2>& Y) {

...
template <typename T, typename T1, typename T2>
arma_warn_unused inline Mat<typename eT_promoter<T1, T2>::eT> kron(const Base<T, T1>& X,
...
// kron(const SpBase<typename T1::elem_type, T1>& A_expr, const SpBase<typename
// T1::elem_type, T2>& B_expr)
//   {
//   arma_extra_debug_sigprint();
//

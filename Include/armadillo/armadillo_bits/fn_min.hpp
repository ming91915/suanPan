...
arma_warn_unused arma_inline const Op<T1, op_min> min(const T1& X,
    const uword dim = 0,
...
template <typename T1>
arma_warn_unused inline typename T1::elem_type min(const T1& X,
...
template <typename T1>
arma_warn_unused arma_inline const Op<Op<T1, op_min>, op_min>

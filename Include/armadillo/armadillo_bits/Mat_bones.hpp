...
public:
    ...
    arma_deprecated inline void reshape(const uword in_rows, const uword in_cols,
    ...
    template <typename fill_type> arma_hot inline const Mat& fill(const fill::fill_class<fill_type>& f);

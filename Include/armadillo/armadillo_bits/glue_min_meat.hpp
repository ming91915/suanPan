...
inline void glue_min::apply(Mat<eT>& out, const Proxy<T1>& PA, const Proxy<T2>& PB)
{
    ...
    arma_debug_assert_same_size(n_rows, n_cols, PB.get_n_rows(), PB.get_n_cols(),
        "min(): given matrices must have the same size");
...
glue_min::apply(Cube<eT>& out, const ProxyCube<T1>& PA, const ProxyCube<T2>& PB)
{
    ...
    arma_debug_assert_same_size(n_rows, n_cols, n_slices, PB.get_n_rows(),
        PB.get_n_cols(), PB.get_n_slices(), "min(): given cubes must have the same size");
...
template <typename T, typename T1, typename T2>
inline void glue_min::apply(Cube<std::complex<T> >& out,

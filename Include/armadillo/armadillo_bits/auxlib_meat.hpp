...
inline bool auxlib::inv(Mat<eT>& out, const Base<eT, T1>& X)
{
    ...
    arma_debug_check(
        (out.is_square() == false), "inv(): given matrix must be square sized");
...
template <typename eT> inline bool auxlib::inv(Mat<eT>& out, const Mat<eT>& X)
{
    ...
    arma_debug_check(
        (X.is_square() == false), "inv(): given matrix must be square sized");
...
inline bool auxlib::inv_noalias_tinymat(Mat<eT>& out, const Mat<eT>& X, const uword N)
{
    ...
    eT* outm =
        out.memptr(); // NOTE: the output matrix is assumed to have the correct size
    ...
    case 3: {
        ...
        if(std::abs(det_val) >= det_min) {
            outm[pos<0, 0>::n3] = (Xm[pos<2, 2>::n3] * Xm[pos<1, 1>::n3] -
                                      Xm[pos<2, 1>::n3] * Xm[pos<1, 2>::n3]) /
                det_val;
            outm[pos<1, 0>::n3] = -(Xm[pos<2, 2>::n3] * Xm[pos<1, 0>::n3] -
                                      Xm[pos<2, 0>::n3] * Xm[pos<1, 2>::n3]) /
                det_val;
            outm[pos<2, 0>::n3] = (Xm[pos<2, 1>::n3] * Xm[pos<1, 0>::n3] -
                                      Xm[pos<2, 0>::n3] * Xm[pos<1, 1>::n3]) /
                det_val;

            outm[pos<0, 1>::n3] = -(Xm[pos<2, 2>::n3] * Xm[pos<0, 1>::n3] -
                                      Xm[pos<2, 1>::n3] * Xm[pos<0, 2>::n3]) /
                det_val;
            outm[pos<1, 1>::n3] = (Xm[pos<2, 2>::n3] * Xm[pos<0, 0>::n3] -
                                      Xm[pos<2, 0>::n3] * Xm[pos<0, 2>::n3]) /
                det_val;
            outm[pos<2, 1>::n3] = -(Xm[pos<2, 1>::n3] * Xm[pos<0, 0>::n3] -
                                      Xm[pos<2, 0>::n3] * Xm[pos<0, 1>::n3]) /
                det_val;

            outm[pos<0, 2>::n3] = (Xm[pos<1, 2>::n3] * Xm[pos<0, 1>::n3] -
                                      Xm[pos<1, 1>::n3] * Xm[pos<0, 2>::n3]) /
                det_val;
            outm[pos<1, 2>::n3] = -(Xm[pos<1, 2>::n3] * Xm[pos<0, 0>::n3] -
                                      Xm[pos<1, 0>::n3] * Xm[pos<0, 2>::n3]) /
                det_val;
            outm[pos<2, 2>::n3] = (Xm[pos<1, 1>::n3] * Xm[pos<0, 0>::n3] -
                                      Xm[pos<1, 0>::n3] * Xm[pos<0, 1>::n3]) /
                det_val;

            const eT check_val = Xm[pos<0, 0>::n3] * outm[pos<0, 0>::n3] +
                Xm[pos<0, 1>::n3] * outm[pos<1, 0>::n3] +
                Xm[pos<0, 2>::n3] * outm[pos<2, 0>::n3];
    ...
    case 4: {
        ...
        if(std::abs(det_val) >= det_min) {
            outm[pos<0, 0>::n4] =
                (Xm[pos<1, 2>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<1, 3>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 1>::n4] +
                    Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 2>::n4] -
                    Xm[pos<1, 1>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 2>::n4] -
                    Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 3>::n4] +
                    Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<1, 0>::n4] =
                (Xm[pos<1, 3>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<1, 2>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<1, 3>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 2>::n4] +
                    Xm[pos<1, 0>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 2>::n4] +
                    Xm[pos<1, 2>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 3>::n4] -
                    Xm[pos<1, 0>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<2, 0>::n4] =
                (Xm[pos<1, 1>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 0>::n4] +
                    Xm[pos<1, 3>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<1, 0>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<1, 1>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 3>::n4] +
                    Xm[pos<1, 0>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<3, 0>::n4] =
                (Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<1, 2>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 1>::n4] +
                    Xm[pos<1, 0>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 1>::n4] +
                    Xm[pos<1, 1>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 2>::n4] -
                    Xm[pos<1, 0>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 2>::n4]) /
                det_val;

            outm[pos<0, 1>::n4] =
                (Xm[pos<0, 3>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 2>::n4] +
                    Xm[pos<0, 1>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 2>::n4] +
                    Xm[pos<0, 2>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 3>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<1, 1>::n4] =
                (Xm[pos<0, 2>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 0>::n4] +
                    Xm[pos<0, 3>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 2>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 2>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 3>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<2, 1>::n4] =
                (Xm[pos<0, 3>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 1>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 1>::n4] +
                    Xm[pos<0, 1>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 3>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<3, 1>::n4] =
                (Xm[pos<0, 1>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 0>::n4] +
                    Xm[pos<0, 2>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 2>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 2>::n4]) /
                det_val;

            outm[pos<0, 2>::n4] =
                (Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<3, 1>::n4] +
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<3, 2>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<3, 2>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<3, 3>::n4] +
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<1, 2>::n4] =
                (Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<3, 2>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<3, 2>::n4] +
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<3, 3>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<2, 2>::n4] =
                (Xm[pos<0, 1>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<3, 0>::n4] +
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<3, 1>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<3, 3>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<3, 3>::n4]) /
                det_val;
            outm[pos<3, 2>::n4] =
                (Xm[pos<0, 2>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<3, 0>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<3, 1>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<3, 1>::n4] +
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<3, 2>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<3, 2>::n4]) /
                det_val;

            outm[pos<0, 3>::n4] =
                (Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4] +
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 2>::n4] +
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 3>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 3>::n4]) /
                det_val;
            outm[pos<1, 3>::n4] =
                (Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 0>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 0>::n4] +
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 2>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 2>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 3>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 3>::n4]) /
                det_val;
            outm[pos<2, 3>::n4] =
                (Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 0>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 0>::n4] -
                    Xm[pos<0, 3>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 1>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] +
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 3>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 3>::n4]) /
                det_val;
            outm[pos<3, 3>::n4] =
                (Xm[pos<0, 1>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 0>::n4] -
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 0>::n4] +
                    Xm[pos<0, 2>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 1>::n4] -
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] -
                    Xm[pos<0, 1>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 2>::n4] +
                    Xm[pos<0, 0>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4]) /
                det_val;

            const eT check_val = Xm[pos<0, 0>::n4] * outm[pos<0, 0>::n4] +
                Xm[pos<0, 1>::n4] * outm[pos<1, 0>::n4] +
                Xm[pos<0, 2>::n4] * outm[pos<2, 0>::n4] +
                Xm[pos<0, 3>::n4] * outm[pos<3, 0>::n4];
...
template <typename eT> inline bool auxlib::inv_inplace_lapack(Mat<eT>& out)
{
...
#if defined(ARMA_USE_ATLAS)
    {
        ...
        info = atlas::clapack_getrf(atlas::CblasColMajor, out.n_rows, out.n_cols,
            out.memptr(), out.n_rows, ipiv.memptr());
        ...
        info = atlas::clapack_getri(
            atlas::CblasColMajor, out.n_rows, out.memptr(), out.n_rows, ipiv.memptr());
...
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        if(n_rows > 16) {
            ...
            lapack::getri(&n_rows, out.memptr(), &n_rows, ipiv.memptr(), &work_query[0],
                &lwork_query, &info);
        ...
        arma_extra_debug_print("lapack::getri()");
        lapack::getri(
            &n_rows, out.memptr(), &n_rows, ipiv.memptr(), work.memptr(), &lwork, &info);
...
inline bool auxlib::inv_sym(Mat<eT>& out, const Base<eT, T1>& X, const uword layout)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::sytrf(
            &uplo, &n, out.memptr(), &n, ipiv.memptr(), work.memptr(), &lwork, &info);
...
inline bool auxlib::inv_sympd(Mat<eT>& out, const Base<eT, T1>& X)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check(
            (out.is_square() == false), "inv_sympd(): given matrix must be square sized");
...
template <typename eT, typename T1> inline eT auxlib::det(const Base<eT, T1>& X)
{
    ...
    arma_debug_check(
        (A.is_square() == false), "det(): given matrix must be square sized");
...
template <typename eT> inline eT auxlib::det_tinymat(const Mat<eT>& X, const uword N)
{
    ...
    case 4: {
        ...
        const eT val = Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] *
                Xm[pos<3, 0>::n4] -
            Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] *
                Xm[pos<3, 0>::n4] -
            Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4] *
...
inline eT auxlib::det_lapack(const Mat<eT>& X, const bool make_copy)
{
...
#if defined(ARMA_USE_ATLAS)
    {
        ...
        arma_extra_debug_print("atlas::clapack_getrf()");
        // const int info =
        atlas::clapack_getrf(atlas::CblasColMajor, tmp.n_rows, tmp.n_cols, tmp.memptr(),
            tmp.n_rows, ipiv.memptr());

        // on output tmp appears to be L+U_alt, where U_alt is U with the main diagonal
        // set to zero
        eT val = tmp.at(0, 0);
        ...
        for(uword i = 0; i < tmp.n_rows; ++i) {
            if(int(i) != ipiv.mem[i]) // NOTE: no adjustment required, as the clapack
                                      // version of getrf() assumes counting from 0
            {
                sign *= -1;
            }
        }
    ...
    const Base<eT, T1>& X)
{
...
#if defined(ARMA_USE_ATLAS)
    {
        ...
        arma_debug_check(
            (tmp.is_square() == false), "log_det(): given matrix must be square sized");
        ...
        sword sign = (is_complex<eT>::value == false) ?
            ((access::tmp_real(tmp.at(0, 0)) < T(0)) ? -1 : +1) :
            +1;
        eT val = (is_complex<eT>::value == false) ?
            std::log((access::tmp_real(tmp.at(0, 0)) < T(0)) ? tmp.at(0, 0) * T(-1) :
                                                               tmp.at(0, 0)) :
            std::log(tmp.at(0, 0));
        ...
        for(uword i = 1; i < tmp.n_rows; ++i) {
            ...
            sign *= (is_complex<eT>::value == false) ?
                ((access::tmp_real(x) < T(0)) ? -1 : +1) :
                +1;
            val += (is_complex<eT>::value == false) ?
...
inline bool auxlib::lu(Mat<eT>& L, Mat<eT>& U, const Base<eT, T1>& X)
{
    ...
    for(uword i = 0; i < n; ++i) {
        ...
        if(ipiv2_mem[i] != ipiv2_mem[k]) {
            std::swap(ipiv2_mem[i], ipiv2_mem[k]);
            L.swap_rows(
                static_cast<uword>(ipiv2_mem[i]), static_cast<uword>(ipiv2_mem[k]));
        }
    }
    ...
    const Base<typename T1::pod_type, T1>& expr)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check(
            (X.is_square() == false), "eig_gen(): given matrix must be square sized");
        ...
        blas_int lwork = (vecs_on) ? (3 * ((std::max)(blas_int(1), 4 * N))) :
                                     (3 * ((std::max)(blas_int(1), 3 * N)));
        blas_int info = 0;
    ...
    const Base<typename T1::pod_type, T2>& B_expr)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check(
            (A.n_rows != B.n_rows), "eig_pair(): given matrices must have the same size");
        ...
        lapack::ggev(&jobvl, &jobvr, &N, A.memptr(), &N, B.memptr(), &N, alphar.memptr(),
            alphai.memptr(), beta.memptr(), vl, &ldvl, vr, &ldvr, work.memptr(), &lwork,
            &info);
    ...
    const Base<std::complex<typename T1::pod_type>, T2>& B_expr)
{
...
#if(defined(ARMA_USE_LAPACK) && defined(ARMA_CRIPPLED_LAPACK))
    {
        ...
        arma_stop_logic_error(
            "eig_pair() for complex matrices not available due to crippled LAPACK");
        return false;
    }
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::cx_ggev(&jobvl, &jobvr, &N, A.memptr(), &N, B.memptr(), &N,
            alpha.memptr(), beta.memptr(), vl, &ldvl, vr, &ldvr, work.memptr(), &lwork,
            rwork.memptr(), &info);
...
inline bool auxlib::eig_sym(Col<eT>& eigval, const Base<eT, T1>& X)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check(
            (A.is_square() == false), "eig_sym(): given matrix must be square sized");
        ...
        lapack::syev(&jobz, &uplo, &N, A.memptr(), &N, eigval.memptr(), work.memptr(),
            &lwork, &info);
...
inline bool auxlib::eig_sym(Col<T>& eigval, const Base<std::complex<T>, T1>& X)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::heev(&jobz, &uplo, &N, A.memptr(), &N, eigval.memptr(), work.memptr(),
...
inline bool auxlib::eig_sym(Col<eT>& eigval, Mat<eT>& eigvec, const Base<eT, T1>& X)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check((eigvec.is_square() == false),
    ...
    const Base<std::complex<T>, T1>& X)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::heevd(&jobz, &uplo, &N, eigvec.memptr(), &N, eigval.memptr(),
            work.memptr(), &lwork, rwork.memptr(), &lrwork, iwork.memptr(), &liwork,
            &info);
...
inline bool auxlib::chol(Mat<eT>& out, const Base<eT, T1>& X, const uword layout)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check(
            (out.is_square() == false), "chol(): given matrix must be square sized");
...
inline bool auxlib::qr(Mat<eT>& Q, Mat<eT>& R, const Base<eT, T1>& X)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::geqrf(
            &m, &n, R.memptr(), &m, tau.memptr(), &work_query[0], &lwork_query, &info);
        ...
        if((is_float<eT>::value) || (is_double<eT>::value)) {
            ...
            lapack::orgqr(
                &m, &m, &k, Q.memptr(), &m, tau.memptr(), work.memptr(), &lwork, &info);
        } else if((is_supported_complex_float<eT>::value) ||
            (is_supported_complex_double<eT>::value)) {
...
inline bool auxlib::qr_econ(Mat<eT>& Q, Mat<eT>& R, const Base<eT, T1>& X)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_extra_debug_print("lapack::geqrf()");
        lapack::geqrf(
            &m, &n, Q.memptr(), &m, tau.memptr(), &work_query[0], &lwork_query, &info);
        ...
        if((is_float<eT>::value) || (is_double<eT>::value)) {
            arma_extra_debug_print("lapack::orgqr()");
            lapack::orgqr(
                &m, &n, &k, Q.memptr(), &m, tau.memptr(), work.memptr(), &lwork, &info);
        } else if((is_supported_complex_float<eT>::value) ||
            (is_supported_complex_double<eT>::value)) {
            arma_extra_debug_print("lapack::ungqr()");
            lapack::ungqr(
...
auxlib::svd(Col<eT>& S, const Base<eT, T1>& X, uword& X_n_rows, uword& X_n_cols)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_extra_debug_print("lapack::gesvd()");
        lapack::gesvd<eT>(&jobu, &jobvt, &m, &n, A.memptr(), &lda, S.memptr(), U.memptr(),
            &ldu, V.memptr(), &ldvt, work.memptr(), &lwork, &info);
...
template <typename T, typename T1>
inline bool auxlib::svd(Col<T>& S,
    const Base<std::complex<T>, T1>& X,
    uword& X_n_rows,
    uword& X_n_cols)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        blas_int lwork_tmp =
            -1; // let gesvd_() calculate the optimum size of the workspace

        arma_extra_debug_print("lapack::cx_gesvd()");
        lapack::cx_gesvd<T>(&jobu, &jobvt, &m, &n, A.memptr(), &lda, S.memptr(),
            U.memptr(), &ldu, V.memptr(), &ldvt, work.memptr(), &lwork_tmp,
            rwork.memptr(), &info);
        ...
        arma_extra_debug_print("lapack::cx_gesvd()");
        lapack::cx_gesvd<T>(&jobu, &jobvt, &m, &n, A.memptr(), &lda, S.memptr(),
            U.memptr(), &ldu, V.memptr(), &ldvt, work.memptr(), &lwork, rwork.memptr(),
            &info);
...
template <typename eT, typename T1>
inline bool auxlib::svd_econ(Mat<eT>& U,
    Col<eT>& S,
    Mat<eT>& V,
    const Base<eT, T1>& X,
    const char mode)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        blas_int lwork =
            3 * ((std::max)(blas_int(1),
                    (std::max)((3 * min_mn + (std::max)(m, n)), 5 * min_mn)));
        blas_int info = 0;
        ...
        arma_extra_debug_print("lapack::gesvd()");
        lapack::gesvd<eT>(&jobu, &jobvt, &m, &n, A.memptr(), &lda, S.memptr(), U.memptr(),
            &ldu, V.memptr(), &ldvt, work.memptr(), &lwork_tmp, &info);
...
auxlib::svd_dc(Col<eT>& S, const Base<eT, T1>& X, uword& X_n_rows, uword& X_n_cols)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::gesdd<eT>(&jobz, &m, &n, A.memptr(), &lda, S.memptr(), U.memptr(), &ldu,
            V.memptr(), &ldvt, work.memptr(), &lwork, iwork.memptr(), &info);
...
template <typename T, typename T1>
inline bool auxlib::svd_dc(Col<T>& S,
    const Base<std::complex<T>, T1>& X,
    uword& X_n_rows,
    uword& X_n_cols)
{
...
#if(defined(ARMA_USE_LAPACK) && defined(ARMA_CRIPPLED_LAPACK))
    {
        arma_extra_debug_print(
            "auxlib::svd_dc(): redirecting to auxlib::svd() due to crippled LAPACK");
...
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        podarray<eT> work(static_cast<uword>(lwork));
        podarray<T> rwork(static_cast<uword>(7 * min_mn)); // LAPACK 3.4.2 docs state
                                                           // 5*min(m,n), while zgesdd()
                                                           // seems to write past the end
        podarray<blas_int> iwork(static_cast<uword>(8 * min_mn));

        arma_extra_debug_print("lapack::cx_gesdd()");
        lapack::cx_gesdd<T>(&jobz, &m, &n, A.memptr(), &lda, S.memptr(), U.memptr(), &ldu,
            V.memptr(), &ldvt, work.memptr(), &lwork, rwork.memptr(), iwork.memptr(),
            &info);
...
inline bool auxlib::svd_dc(Mat<eT>& U, Col<eT>& S, Mat<eT>& V, const Base<eT, T1>& X)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        blas_int ldvt = blas_int(V.n_rows);
        blas_int lwork1 =
            3 * min_mn * min_mn + (std::max)(max_mn, 4 * min_mn * min_mn + 4 * min_mn);
        blas_int lwork2 =
            3 * min_mn + (std::max)(max_mn, 4 * min_mn * min_mn + 3 * min_mn + max_mn);
        blas_int lwork = 2 *
            ((std::max)(lwork1, lwork2)); // due to differences between lapack 3.1 and 3.4
        blas_int info = 0;
    ...
    const Base<std::complex<T>, T1>& X)
{
...
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        blas_int lrwork =
            (std::max)(lrwork1, lrwork2); // due to differences between lapack 3.1 and 3.4
        blas_int info = 0;
...
#if(defined(ARMA_USE_LAPACK) && defined(ARMA_CRIPPLED_LAPACK))
    {
        arma_extra_debug_print("auxlib::svd_dc_econ(): redirecting to auxlib::svd_econ() "
    ...
    const Base<typename T1::elem_type, T1>& B_expr)
{
    ...
    if(A_n_rows <= 4) {
        ...
        if(status == true) {
            ...
            arma_debug_check((A_n_rows != B_n_rows),
                "solve(): number of rows in the given matrices must be the same");
...
#if defined(ARMA_USE_ATLAS)
    {
        ...
        podarray<int> ipiv(A_n_rows +
            2); // +2 for paranoia: old versions of Atlas might be trashing memory
...
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::gesv<eT>(
            &n, &nrhs, A.memptr(), &lda, ipiv.memptr(), out.memptr(), &ldb, &info);
    ...
    const bool equilibrate)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::gesvx(&fact, &trans, &n, &nrhs, A.memptr(), &lda, AF.memptr(), &ldaf,
            IPIV.memptr(), &equed, R.memptr(), C.memptr(), B.memptr(), &ldb, out.memptr(),
            &ldx, &rcond, FERR.memptr(), BERR.memptr(), WORK.memptr(), IWORK.memptr(),
            &info);

        // if(info == (n+1))  { arma_debug_warn("solve(): matrix appears singular to
    ...
    const bool equilibrate)
{
...
#if(defined(ARMA_USE_LAPACK) && defined(ARMA_CRIPPLED_LAPACK))
    {
        ...
        arma_debug_warn(
            "solve(): refinement and/or equilibration not done due to crippled LAPACK");
...
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::cx_gesvx(&fact, &trans, &n, &nrhs, A.memptr(), &lda, AF.memptr(), &ldaf,
            IPIV.memptr(), &equed, R.memptr(), C.memptr(), B.memptr(), &ldb, out.memptr(),
            &ldx, &rcond, FERR.memptr(), BERR.memptr(), WORK.memptr(), RWORK.memptr(),
            &info);
...
template <typename T1>
inline bool auxlib::solve_approx_fast(Mat<typename T1::elem_type>& out,
    Mat<typename T1::elem_type>& A,
    const Base<typename T1::elem_type, T1>& B_expr)
{
    arma_extra_debug_sigprint();
    ...
    const Base<typename T1::pod_type, T1>& B_expr)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        blas_int smlsiz =
            (std::max)(blas_int(25), lapack::laenv(&ispec, name, opts, &n1, &n2, &n3,
                                         &n4)); // in case lapack::laenv() returns -1
        blas_int smlsiz_p1 = blas_int(1) + smlsiz;

        blas_int nlvl = (std::max)(blas_int(0),
            blas_int(1) + blas_int(std::log(double(min_mn) / double(smlsiz_p1)) /
                              double(0.69314718055994530942)));
        blas_int liwork = (std::max)(blas_int(1),
            (blas_int(3) * blas_int(min_mn) * nlvl + blas_int(11) * blas_int(min_mn)));
        ...
        lapack::gelsd(&m, &n, &nrhs, A.memptr(), &lda, tmp.memptr(), &ldb, S.memptr(),
            &rcond, &rank, &work_query[0], &lwork_query, iwork.memptr(), &info);
        ...
        arma_extra_debug_print("lapack::gelsd()");
        lapack::gelsd(&m, &n, &nrhs, A.memptr(), &lda, tmp.memptr(), &ldb, S.memptr(),
            &rcond, &rank, work.memptr(), &lwork, iwork.memptr(), &info);
    ...
    const Base<std::complex<typename T1::pod_type>, T1>& B_expr)
{
...
#if(defined(ARMA_USE_LAPACK) && defined(ARMA_CRIPPLED_LAPACK))
    {
        ...
        arma_ignore(B_expr);
        arma_debug_warn(
            "solve() for rank-deficient matrices not available due to crippled LAPACK");
        return false;
    }
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        blas_int lrwork = (m >= n) ?
            blas_int(10) * n + blas_int(2) * n * smlsiz + blas_int(8) * n * nlvl +
        ...
        lapack::cx_gelsd(&m, &n, &nrhs, A.memptr(), &lda, tmp.memptr(), &ldb, S.memptr(),
            &rcond, &rank, &work_query[0], &lwork_query, rwork.memptr(), iwork.memptr(),
            &info);
        ...
        arma_extra_debug_print("lapack::cx_gelsd()");
        lapack::cx_gelsd(&m, &n, &nrhs, A.memptr(), &lda, tmp.memptr(), &ldb, S.memptr(),
            &rcond, &rank, work.memptr(), &lwork, rwork.memptr(), iwork.memptr(), &info);
...
template <typename T1>
inline bool auxlib::solve_tri(Mat<typename T1::elem_type>& out,
    ...
    const uword layout)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::trtrs(
            &uplo, &trans, &diag, &n, &nrhs, A.memptr(), &n, out.memptr(), &n, &info);
...
auxlib::schur(Mat<eT>& U, Mat<eT>& S, const Base<eT, T1>& X, const bool calc_U)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check(
            (S.is_square() == false), "schur(): given matrix must be square sized");
        ...
        lapack::gees(&jobvs, &sort, select, &n, S.memptr(), &n, &sdim, wr.memptr(),
            wi.memptr(), U.memptr(), &ldvs, work.memptr(), &lwork, bwork.memptr(), &info);
...
auxlib::schur(Mat<std::complex<T>>& U, Mat<std::complex<T>>& S, const bool calc_U)
{
...
#if(defined(ARMA_USE_LAPACK) && defined(ARMA_CRIPPLED_LAPACK))
    {
        ...
        arma_ignore(calc_U);
        arma_stop_logic_error(
            "schur() for complex matrices not available due to crippled LAPACK");
        return false;
    }
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::cx_gees(&jobvs, &sort, select, &n, S.memptr(), &n, &sdim, w.memptr(),
            U.memptr(), &ldvs, work.memptr(), &lwork, rwork.memptr(), bwork.memptr(),
            &info);
    ...
    const char mode)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check(
            (A.n_rows != B.n_rows), "qz(): given matrices must have the same size");
        ...
        lapack::gges(&jobvsl, &jobvsr, &eigsort, selctg, &N, A.memptr(), &N, B.memptr(),
            &N, &sdim, alphar.memptr(), alphai.memptr(), beta.memptr(), vsl.memptr(), &N,
    ...
    const char mode)
{
...
#if(defined(ARMA_USE_LAPACK) && defined(ARMA_CRIPPLED_LAPACK))
    {
        ...
        arma_ignore(Y_expr);
        arma_stop_logic_error(
            "qz() for complex matrices not available due to crippled LAPACK");
        return false;
    }
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::cx_gges(&jobvsl, &jobvsr, &eigsort, selctg, &N, A.memptr(), &N,
            B.memptr(), &N, &sdim, alpha.memptr(), beta.memptr(), vsl.memptr(), &N,
            vsr.memptr(), &N, work.memptr(), &lwork, rwork.memptr(), bwork.memptr(),
            &info);
...
inline typename T1::pod_type auxlib::rcond(const Base<typename T1::pod_type, T1>& A_expr)
{
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        arma_debug_check(
            (A.is_square() == false), "rcond(): matrix must be square sized");
...
template <typename T1>
inline typename T1::pod_type auxlib::rcond(
    const Base<std::complex<typename T1::pod_type>, T1>& A_expr)
{
    typedef typename T1::pod_type T;
...
inline blas_int select_ouc(const T* x_ptr, const T* y_ptr, const T* z_ptr)
{
    ...
    if(z == T(0)) {
        return (x == T(0)) ?
            blas_int(0) :
            blas_int(
                1); // consider an infinite eig value to be outside of the unit circle
    }

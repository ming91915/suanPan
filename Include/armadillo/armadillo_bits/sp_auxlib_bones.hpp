...
public:
    ...
    inline static bool eigs_sym(Col<eT>& eigval,
        Mat<eT>& eigvec,
    ...
    template <typename eT, typename T1>
    inline static bool eigs_sym_newarp(Col<eT>& eigval,
        Mat<eT>& eigvec,
        const SpBase<eT, T1>& X,
        const uword n_eigvals,
        const char* form_str,
    ...
    template <typename eT, typename T1>
    inline static bool eigs_sym_arpack(Col<eT>& eigval,
        Mat<eT>& eigvec,
        const SpBase<eT, T1>& X,
        const uword n_eigvals,
        const char* form_str,
...
private:
    ...
    inline static void run_aupd(const uword n_eigvals,
        char* which,
        const SpProxy<T1>& p,
        const bool sym,
        blas_int& n,

...
struct is_arma_sparse_type {
    static const bool value = is_SpMat<T1>::value || is_SpSubview<T1>::value || is_spdiagview<T1>::value || is_SpOp<T1>::value || is_SpGlue<T1>::value || is_mtSpOp<T1>::value;
};
...
struct is_supported_blas_type {
    static const bool value = is_float<T1>::value || is_double<T1>::value || is_supported_complex_float<T1>::value || is_supported_complex_double<T1>::value;
};

...
//// Comment out the above line if you're getting linking errors when compiling your
/// programs,
//// or if you prefer to directly link with LAPACK, BLAS + etc instead of the Armadillo
/// runtime library.
//// You will then need to link your programs directly with -llapack -lblas instead of
///-larmadillo

// #define ARMA_BLAS_CAPITALS
//// Uncomment the above line if your BLAS and LAPACK libraries have capitalised function
/// names (eg. ACML on 64-bit Windows)
...
/// scalable_free() instead of standard malloc() and free()

// #define ARMA_USE_MKL_ALLOC
//// Uncomment the above line if you want to use Intel MKL mkl_malloc() and mkl_free()
...
//// Uncomment the above line to forcefully enable use of C++11 features (eg. initialiser
/// lists).
...
//// Note that ARMA_USE_OPENMP is automatically enabled when a compiler supporting OpenMP
/// 3.0 is detected.
#endif
...
/// 4 billion elements.
//// Your machine and compiler must have support for 64 bit integers (eg. via "long" or
///"long long").
...
#endif
//// This is the minimum increase in the amount of memory (in terms of elements) allocated
/// by a sparse matrix;
//// it must be an integer that is at least 1.
...
//// This will result in faster code, but you first need to make sure that your code runs
/// correctly!
//// We strongly recommend to have the run-time checks enabled during development,
//// as this greatly aids in finding mistakes in your code, and hence speeds up
/// development.
//// We recommend that run-time checks be disabled _only_ for the shipped version of your
/// program.

// #define ARMA_EXTRA_DEBUG
//// Uncomment the above line if you want to see the function traces of how Armadillo
...
//// Comment out the above line if you don't want errors and warnings printed (eg. failed
/// decompositions)
#endif

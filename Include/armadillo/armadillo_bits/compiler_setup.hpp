...
// TODO: thread local storage (TLS) (eg. "extern thread_local") appears currently broken
// on Mac OS X
#endif
...
// if the compiler has an ancient version of OpenMP and use of OpenMP hasn't been
// explicitly disabled,
...
//
// whoever defined macros with the names "min" and "max" should be permanently removed
// from the gene pool

...
//! such as the operand (e.g. the matrix to which the operation is to be applied) and the
//! unary operator (e.g. inverse).
...
public:
    ...
    static const bool is_row =
        (
            ...
            T1::is_row && (is_same_type<op_type, op_sort_default>::yes ||
        ...
        (
            ...
            T1::is_col && (is_same_type<op_type, op_strans>::yes ||
    ...
    static const bool is_col = (
        ...
        (
            ...
            T1::is_row && (is_same_type<op_type, op_strans>::yes ||
                              is_same_type<op_type, op_htrans>::yes ||
                              is_same_type<op_type, op_htrans2>::yes));
};

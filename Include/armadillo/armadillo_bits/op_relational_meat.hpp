        ...
        if(bad_alias == false) {                                                                                                                \
            ...
            if(Proxy<T1>::use_at == false) {                                                                                                    \
                ...
                const uword n_elem = out.n_elem;                                                                                                \
                                                                                                                                                \
                for(uword i = 0; i < n_elem; ++i) { out_mem[i] = (val operator_rel PA[i]) ? uword(1) : uword(0); }                              \
            } else {                                                                                                                            \
                if(n_rows == 1) {                                                                                                               \
                    for(uword count = 0; count < n_cols; ++count) { out_mem[count] = (val operator_rel P.at(0, count)) ? uword(1) : uword(0); } \
                } else {                                                                                                                        \
    ...
    {                                                                                                                                           \
        ...
        if(bad_alias == false) {                                                                                                                \
            ...
            if(Proxy<T1>::use_at == false) {                                                                                                    \
                ...
                const uword n_elem = out.n_elem;                                                                                                \
                                                                                                                                                \
                for(uword i = 0; i < n_elem; ++i) { out_mem[i] = (PA[i] operator_rel val) ? uword(1) : uword(0); }                              \
            } else {                                                                                                                            \
                if(n_rows == 1) {                                                                                                               \
                    for(uword count = 0; count < n_cols; ++count) { out_mem[count] = (P.at(0, count) operator_rel val) ? uword(1) : uword(0); } \
                } else {                                                                                                                        \
                    for(uword col = 0; col < n_cols; ++col)                                                                                     \
                        for(uword row = 0; row < n_rows; ++row) {                                                                               \

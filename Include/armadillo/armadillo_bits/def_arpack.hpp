...
void arma_fortran(arma_snaupd)(blas_int* ido,
    char* bmat,
    blas_int* n,
    char* which,
    blas_int* nev,
    ...
    blas_int* lworkl,
    blas_int* info);
void arma_fortran(arma_dnaupd)(blas_int* ido,
    char* bmat,
    blas_int* n,
    char* which,
    blas_int* nev,
    ...
    blas_int* lworkl,
    blas_int* info);
void arma_fortran(arma_cnaupd)(blas_int* ido,
    char* bmat,
    blas_int* n,
    char* which,
    blas_int* nev,
    ...
    float* rwork,
    blas_int* info);
void arma_fortran(arma_znaupd)(blas_int* ido,
    char* bmat,
    blas_int* n,
    char* which,
    blas_int* nev,
...
void arma_fortran(arma_ssaupd)(blas_int* ido,
    char* bmat,
    blas_int* n,
    char* which,
    blas_int* nev,
    ...
    blas_int* lworkl,
    blas_int* info);
void arma_fortran(arma_dsaupd)(blas_int* ido,
    char* bmat,
    blas_int* n,
    char* which,
    blas_int* nev,
...
void arma_fortran(arma_dneupd)(blas_int* rvec,
    ...
    blas_int* lworkl,
    blas_int* info);
void arma_fortran(arma_cneupd)(blas_int* rvec,
    char* howmny,
    blas_int* select,
    void* d,
    void* z,
    ...
    float* rwork,
    blas_int* info);
void arma_fortran(arma_zneupd)(blas_int* rvec,
    char* howmny,
    blas_int* select,
    void* d,
    void* z,
...
void arma_fortran(arma_sseupd)(blas_int* rvec,
    char* howmny,
    blas_int* select,
    float* d,
    float* z,

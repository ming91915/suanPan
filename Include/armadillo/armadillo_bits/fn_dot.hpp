...
template <typename T1, typename T2>
arma_warn_unused arma_inline typename enable_if2<is_arma_type<T2>::value &&
        is_same_type<typename T1::elem_type, typename T2::elem_type>::value &&
        is_complex<typename T1::elem_type>::value,
    typename T1::elem_type>::result
...
template <typename T1, typename T2>
arma_warn_unused arma_hot inline typename enable_if2<(is_arma_sparse_type<T1>::value) &&
...
dot(const T1& x, const T2& y)
{
    ...
    arma_debug_assert_same_size(
        pa.get_n_rows(), pa.get_n_cols(), pb.get_n_rows(), pb.get_n_cols(), "dot()");
...
arma_warn_unused arma_hot inline
    typename enable_if2<(is_arma_type<T1>::value) && (is_arma_sparse_type<T2>::value) &&
            (is_same_type<typename T1::elem_type, typename T2::elem_type>::value),
        typename T1::elem_type>::result
    dot(const T1& x, const T2& y)
{
...
template <typename T1, typename T2>
arma_warn_unused arma_hot inline
    typename enable_if2<(is_arma_sparse_type<T1>::value) && (is_arma_type<T2>::value) &&
            (is_same_type<typename T1::elem_type, typename T2::elem_type>::value),
        typename T1::elem_type>::result
    dot(const T1& x, const T2& y)
{

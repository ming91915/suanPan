...
arma_inline const eOpCube<T1, eop_scalar_div_post> operator/(const BaseCube<typename T1::elem_type, T1>& X, const typename T1::elem_type k) {
...
//! scalar / BaseCube
template <typename T1>
arma_inline const eOpCube<T1, eop_scalar_div_pre> operator/(const typename T1::elem_type k, const BaseCube<typename T1::elem_type, T1>& X) {
    arma_extra_debug_sigprint();
...
template <typename T1>
arma_inline const mtOpCube<typename std::complex<typename T1::pod_type>, T1, op_cx_scalar_div_pre> operator/(const std::complex<typename T1::pod_type>& k, const BaseCube<typename T1::pod_type, T1>& X) {
    arma_extra_debug_sigprint();
...
template <typename T1>
arma_inline const mtOpCube<typename std::complex<typename T1::pod_type>, T1, op_cx_scalar_div_post> operator/(const BaseCube<typename T1::pod_type, T1>& X, const std::complex<typename T1::pod_type>& k) {
    arma_extra_debug_sigprint();
...
arma_inline const eGlueCube<T1, T2, eglue_div> operator/(const BaseCube<typename T1::elem_type, T1>& X, const BaseCube<typename T1::elem_type, T2>& Y) {
    arma_extra_debug_sigprint();

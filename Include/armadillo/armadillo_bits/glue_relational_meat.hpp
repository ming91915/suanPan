        ...
        if(bad_alias == false) {                                                                                                                             \
            ...
            if(use_at == false) {                                                                                                                            \
                ...
                const uword n_elem = out.n_elem;                                                                                                             \
                                                                                                                                                             \
                for(uword i = 0; i < n_elem; ++i) { out_mem[i] = (A[i] operator_rel B[i]) ? uword(1) : uword(0); }                                           \
            } else {                                                                                                                                         \
                if(n_rows == 1) {                                                                                                                            \
                    for(uword count = 0; count < n_cols; ++count) { out_mem[count] = (P1.at(0, count) operator_rel P2.at(0, count)) ? uword(1) : uword(0); } \
                } else {                                                                                                                                     \

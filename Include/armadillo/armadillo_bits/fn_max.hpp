...
arma_warn_unused arma_inline const Op<T1, op_max> max(const T1& X,
    const uword dim = 0,
...
template <typename T1>
arma_warn_unused inline typename T1::elem_type max(const T1& X,
...
template <typename T1>
arma_warn_unused arma_inline const Op<Op<T1, op_max>, op_max>

...
H5_DLL H5HF_hdr_t* H5HF_hdr_protect(H5F_t* f, hid_t dxpl_id, haddr_t addr, unsigned flags);
...
H5_DLL H5HF_indirect_t* H5HF_man_iblock_protect(H5HF_hdr_t* hdr, hid_t dxpl_id, haddr_t iblock_addr, unsigned iblock_nrows, H5HF_indirect_t* par_iblock, unsigned par_entry, hbool_t must_protect, unsigned flags, hbool_t* did_protect);
...
H5_DLL herr_t H5HF_man_iblock_size(H5F_t* f, hid_t dxpl_id, H5HF_hdr_t* hdr, haddr_t iblock_addr, unsigned nrows, H5HF_indirect_t* par_iblock, unsigned par_entry, hsize_t* heap_size /*out*/);
...
H5_DLL H5HF_direct_t* H5HF_man_dblock_protect(H5HF_hdr_t* hdr, hid_t dxpl_id, haddr_t dblock_addr, size_t dblock_size, H5HF_indirect_t* par_iblock, unsigned par_entry, unsigned flags);
H5_DLL herr_t H5HF_man_dblock_locate(H5HF_hdr_t* hdr, hid_t dxpl_id, hsize_t obj_off, H5HF_indirect_t** par_iblock, unsigned* par_entry, hbool_t* par_did_protect, unsigned flags);
...
H5_DLL herr_t H5HF__huge_get_obj_off(H5HF_hdr_t* hdr, hid_t dxpl_id, const uint8_t* id, hsize_t* obj_off_p);
...
H5_DLL herr_t H5HF_space_sect_change_class(H5HF_hdr_t* hdr, hid_t dxpl_id, H5HF_free_section_t* sect, uint16_t new_class);
...
H5_DLL herr_t H5HF_sect_single_dblock_info(H5HF_hdr_t* hdr, H5HF_free_section_t* sect, haddr_t* dblock_addr, size_t* dblock_size);

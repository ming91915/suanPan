...
H5E_FUNC_g = H5E_FILE_g = H5E_SOHM_g = H5E_SYM_g = H5E_PLUGIN_g = H5E_VFL_g = H5E_INTERNAL_g = H5E_BTREE_g = H5E_REFERENCE_g = H5E_DATASPACE_g = H5E_RESOURCE_g = H5E_RS_g = H5E_FARRAY_g = H5E_HEAP_g = H5E_ATTR_g = H5E_IO_g = H5E_EFL_g = H5E_TST_g = H5E_PAGEBUF_g = H5E_FSPACE_g = H5E_DATASET_g = H5E_STORAGE_g = H5E_LINK_g = H5E_PLIST_g = H5E_DATATYPE_g = H5E_OHDR_g = H5E_ATOM_g = H5E_NONE_MAJOR_g = H5E_SLIST_g = H5E_ARGS_g = H5E_EARRAY_g = H5E_PLINE_g = H5E_ERROR_g = H5E_CACHE_g = (-1);
...
H5E_SEEKERROR_g = H5E_READERROR_g = H5E_WRITEERROR_g = H5E_CLOSEERROR_g = H5E_OVERFLOW_g = H5E_FCNTL_g =
    ...
    /* Resource errors */
    H5E_NOSPACE_g = H5E_CANTALLOC_g = H5E_CANTCOPY_g = H5E_CANTFREE_g = H5E_ALREADYEXISTS_g = H5E_CANTLOCK_g = H5E_CANTUNLOCK_g = H5E_CANTGC_g = H5E_CANTGETSIZE_g = H5E_OBJOPEN_g =

        /* Heap errors */
    H5E_CANTRESTORE_g = H5E_CANTCOMPUTE_g = H5E_CANTEXTEND_g = H5E_CANTATTACH_g = H5E_CANTUPDATE_g = H5E_CANTOPERATE_g =
    ...
    H5E_LINKCOUNT_g = H5E_VERSION_g = H5E_ALIGNMENT_g = H5E_BADMESG_g = H5E_CANTDELETE_g = H5E_BADITER_g = H5E_CANTPACK_g = H5E_CANTRESET_g = H5E_CANTRENAME_g =
    ...
    H5E_MPI_g = H5E_MPIERRSTR_g = H5E_CANTRECV_g =
        ...
        /* Dataspace errors */
    H5E_CANTCLIP_g = H5E_CANTCOUNT_g = H5E_CANTSELECT_g = H5E_CANTNEXT_g = H5E_BADSELECT_g = H5E_CANTCOMPARE_g = H5E_CANTAPPEND_g =

        /* Argument errors */
    H5E_UNINITIALIZED_g = H5E_UNSUPPORTED_g = H5E_BADTYPE_g = H5E_BADRANGE_g = H5E_BADVALUE_g =

        /* B-tree related errors */
    H5E_NOTFOUND_g = H5E_EXISTS_g = H5E_CANTENCODE_g = H5E_CANTDECODE_g = H5E_CANTSPLIT_g = H5E_CANTREDISTRIBUTE_g = H5E_CANTSWAP_g = H5E_CANTINSERT_g = H5E_CANTLIST_g = H5E_CANTMODIFY_g = H5E_CANTREMOVE_g =

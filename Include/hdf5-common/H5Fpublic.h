...
typedef enum H5F_fspace_strategy_t {
    ...
    H5F_FSPACE_STRATEGY_PAGE = 1, /* Mechanisms: free-space managers with embedded paged
...
typedef enum H5F_file_space_type_t {
    ...
    H5F_FILE_SPACE_ALL_PERSIST =
        1, /* Persistent free space managers, aggregators, virtual file driver */
    H5F_FILE_SPACE_ALL =
        2, /* Non-persistent free space managers, aggregators, virtual file driver */
...
/* Data structure to report the collection of read retries for metadata items with
 * checksum */

...
public:
    ...
    // void fillMemBuf(const void *fill, DataType& fill_type, void *buf, DataType&
    // buf_type, DataSpace& space); // removed from 1.8.18 and 1.10.1

    // Fills a selection in memory with zero
    void fillMemBuf(void* buf, const DataType& buf_type, const DataSpace& space) const;
    // void fillMemBuf(void *buf, DataType& buf_type, DataSpace& space); // removed from
    // 1.8.18 and 1.10.1
    ...
    // hsize_t getVlenBufSize(DataType& type, DataSpace& space) const; // removed from
    // 1.8.18 and 1.10.1

    // Reclaims VL datatype memory buffers.
    static void vlenReclaim(const DataType& type,
    ...
    // Iterates the selected elements in the specified dataspace - not implemented in C++
    // style yet

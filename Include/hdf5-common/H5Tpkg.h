...
#define H5T_IS_VL_STRING(dt) \
    (H5T_VLEN == (dt)->type && H5T_VLEN_STRING == (dt)->u.vlen.type)
...
#define H5T_GET_CLASS(shared, internal) \
    ((internal) ? (shared)->type :      \
                  (H5T_IS_VL_STRING(shared) ? H5T_STRING : (shared)->type))
...
#define H5T_VISIT_COMPLEX_FIRST \
    0x01 /* Visit complex datatype before visiting member/parent datatypes */
#define H5T_VISIT_COMPLEX_LAST \
    0x02 /* Visit complex datatype after visiting member/parent datatypes */
         /* (setting both flags will mean visiting complex type twice) */
#define H5T_VISIT_SIMPLE 0x04 /* Visit simple datatypes (at all) */
/* (setting H5T_VISIT_SIMPLE and _not_ setting either H5T_VISIT_COMPLEX_FIRST or
 * H5T_VISIT_COMPLEX_LAST will mean visiting _only_ "simple" "leafs" in the "tree" */
/* (_not_ setting H5T_VISIT_SIMPLE and setting either H5T_VISIT_COMPLEX_FIRST or
 * H5T_VISIT_COMPLEX_LAST will mean visiting all nodes _except_ "simple" "leafs" in the
 * "tree" */

/* Define an internal macro for converting long long to long double.  Mac OS 10.4 gives
 * some
...
/* Define an internal macro for converting unsigned long long to long double.  SGI
 * compilers give
 * some incorect conversion.  64-bit Solaris does different rounding.   Windows Visual
 * Studio 6 does
 * not support unsigned long long.  For FreeBSD(sleipnir), the last 2 bytes of mantissa
 * are lost when
 * compiler tries to do the conversion.  For Cygwin, compiler doesn't do rounding
 * correctly.
...
/* Define an internal macro for converting long double to long long.  SGI compilers give
 * some incorrect
 * conversions. Mac OS 10.4 gives incorrect conversions. HP-UX 11.00 compiler generates
 * floating exception.
...
/* Define an internal macro for converting long double to unsigned long long.  SGI
 * compilers give some
 * incorrect conversions.  Mac OS 10.4 gives incorrect conversions. HP-UX 11.00 compiler
 * generates
 * floating exception. */
#if(H5_WANT_DATA_ACCURACY && defined(H5_LDOUBLE_TO_LLONG_ACCURATE)) || \
    (!H5_WANT_DATA_ACCURACY)
...
typedef herr_t (
    *H5T_vlen_readfunc_t)(H5F_t* f, hid_t dxpl_id, void* _vl, void* buf, size_t len);
typedef herr_t (*H5T_vlen_writefunc_t)(H5F_t* f,
    hid_t dxpl_id,
...
typedef struct H5T_vlen_t {
    ...
    H5T_vlen_getlenfunc_t
        getlen; /* Function to get VL sequence size (in element units, not bytes) */
...
typedef struct H5T_shared_t {
    ...
    hbool_t force_conv; /* Set if this type always needs to be converted and
                           H5T__conv_noop cannot be called */
...
H5_DLL herr_t H5T__commit_named(const H5G_loc_t* loc,
    const char* name,
    H5T_t* dt,
    hid_t lcpl_id,
    hid_t tcpl_id,
...
H5_DLL herr_t H5T__visit(H5T_t* dt,
    unsigned visit_flags,
    H5T_operator_t op,
    void* op_value);
H5_DLL herr_t H5T__upgrade_version(H5T_t* dt, unsigned new_version);

/* Conversion functions */
H5_DLL herr_t H5T__conv_noop(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
...
H5_DLL herr_t H5T__conv_order(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_order_opt(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_struct(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_struct_opt(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_enum(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_enum_numeric(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_vlen(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_array(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_i_i(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_f_f(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_f_i(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_i_f(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_s_s(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_b_b(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
...
H5_DLL herr_t H5T__conv_schar_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
...
H5_DLL herr_t H5T__conv_short_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
...
H5_DLL herr_t H5T__conv_int_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
...
H5_DLL herr_t H5T__conv_long_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
...
H5_DLL herr_t H5T__conv_llong_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_schar_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uchar_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_short_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ushort_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_int_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_uint_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_long_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ulong_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_llong_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_float(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_double(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ullong_ldouble(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_float_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_double_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_schar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_uchar(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_short(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_ushort(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_int(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_uint(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_long(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_ulong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_llong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
    ...
    void* bkg,
    hid_t dset_xfer_plist);
H5_DLL herr_t H5T__conv_ldouble_ullong(hid_t src_id,
    hid_t dst_id,
    H5T_cdata_t* cdata,
    size_t nelmts,
    size_t buf_stride,
...
H5_DLL void H5T__bit_copy(uint8_t* dst,
    size_t dst_offset,
    const uint8_t* src,
    size_t src_offset,
    size_t size);
H5_DLL herr_t H5T__bit_shift(uint8_t* buf,
    ssize_t shift_dist,
    size_t offset,
    size_t size);
...
H5_DLL ssize_t H5T__bit_find(uint8_t* buf,
    size_t offset,
    size_t size,
...
/* Compound functions */
H5_DLL herr_t H5T__insert(H5T_t* parent,
    const char* name,
    size_t offset,
    const H5T_t* member);

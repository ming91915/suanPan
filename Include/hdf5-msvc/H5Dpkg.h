...
H5_DLL H5D_t* H5D__open_name(const H5G_loc_t* loc, const char* name, hid_t dapl_id, hid_t dxpl_id);
...
H5_DLL herr_t H5D__read(H5D_t* dataset, hid_t mem_type_id, const H5S_t* mem_space, const H5S_t* file_space, hid_t dset_xfer_plist, void* buf /*out*/);
H5_DLL herr_t H5D__write(H5D_t* dataset, hid_t mem_type_id, const H5S_t* mem_space, const H5S_t* file_space, hid_t dset_xfer_plist, const void* buf);
...
H5_DLL herr_t H5D__layout_set_latest_version(H5O_layout_t* layout, const H5S_t* space, const H5D_dcpl_cache_t* dcpl_cache);
...
H5_DLL herr_t H5D__chunk_lookup(const H5D_t* dset, hid_t dxpl_id, const hsize_t* scaled, H5D_chunk_ud_t* udata);
...
H5_DLL herr_t H5D__chunk_update_old_edge_chunks(H5D_t* dset, hid_t dxpl_id, hsize_t old_dim[]);
...
H5_DLL herr_t H5D__chunk_bh_info(const H5O_loc_t* loc, hid_t dxpl_id, H5O_t* oh, H5O_layout_t* layout, hsize_t* btree_size);
...
H5_DLL herr_t H5D__virtual_init(H5F_t* f, hid_t dxpl_id, const H5D_t* dset, hid_t dapl_id);
 ...
 * memory and the file */
H5_DLL htri_t H5D__mpio_opt_possible(const H5D_io_info_t* io_info, const H5S_t* file_space, const H5S_t* mem_space, const H5D_type_info_t* type_info, const H5D_chunk_map_t* fm, H5P_genplist_t* dx_plist);

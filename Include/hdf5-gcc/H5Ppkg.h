...
struct H5P_genclass_t {
    ...
    unsigned plists;    /* Number of property lists that have been created since the last
                           modification to the class */
    unsigned classes;   /* Number of classes that have been derived since the last
                           modification to the class */
    unsigned ref_count; /* Number of oustanding ID's open on this class object */
    hbool_t deleted;   /* Whether this class has been deleted and is waiting for dependent
                          classes & proplists to close */
...
struct H5P_genplist_t {
    ...
    size_t nprops;          /* Number of properties in class */
    hbool_t
        class_init; /* Whether the class initialization callback finished successfully */

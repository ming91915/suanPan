...
if(((((head_ptr) == NULL) || ((tail_ptr) == NULL)) && ((head_ptr) != (tail_ptr))) || \
        ((len) < 0) || ((Size) < 0) ||                                               \
        (((len) == 1) && (((head_ptr) != (tail_ptr)) || ((head_ptr) == NULL) ||      \
                             ((head_ptr)->size != (Size)))) ||                       \
        (((len) >= 1) && (((head_ptr) == NULL) || ((head_ptr)->prev != NULL) ||      \
...
#define H5C__DLL_PRE_INSERT_SC(entry_ptr, head_ptr, tail_ptr, len, Size, fv)       \
    \
if(((entry_ptr) == NULL) || ((entry_ptr)->next != NULL) ||                         \
        ((entry_ptr)->prev != NULL) ||                                             \
...
#define H5C__AUX_DLL_PRE_REMOVE_SC(entry_ptr, hd_ptr, tail_ptr, len, Size, fv)        \
    \
if(((hd_ptr) == NULL) || ((tail_ptr) == NULL) || ((entry_ptr) == NULL) ||             \
        ((len) <= 0) || ((Size) < (entry_ptr)->size) ||                               \
        (((Size) == (entry_ptr)->size) && (!((len) == 1))) ||                         \
        ...
        (((len) == 1) &&                                                              \
            (!(((hd_ptr) == (entry_ptr)) && ((tail_ptr) == (entry_ptr)) &&            \
                ((entry_ptr)->aux_next == NULL) && ((entry_ptr)->aux_prev == NULL) && \
                ((Size) == (entry_ptr)->size)))))                                     \
    {                                                                                 \
...
if(((((head_ptr) == NULL) || ((tail_ptr) == NULL)) && ((head_ptr) != (tail_ptr))) ||   \
        ((len) < 0) || ((Size) < 0) ||                                                 \
        (((len) == 1) && (((head_ptr) != (tail_ptr)) || ((Size) <= 0) ||               \
                             ((head_ptr) == NULL) || ((head_ptr)->size != (Size)))) || \
        (((len) >= 1) && (((head_ptr) == NULL) || ((head_ptr)->aux_prev != NULL) ||    \
...
#define H5C__AUX_DLL_PRE_INSERT_SC(entry_ptr, hd_ptr, tail_ptr, len, Size, fv)         \
    \
if(((entry_ptr) == NULL) || ((entry_ptr)->aux_next != NULL) ||                         \
        ((entry_ptr)->aux_prev != NULL) ||                                             \
        ((((hd_ptr) == NULL) || ((tail_ptr) == NULL)) && ((hd_ptr) != (tail_ptr))) ||  \
        (((len) == 1) && (((hd_ptr) != (tail_ptr)) || ((Size) <= 0) ||                 \
                             ((hd_ptr) == NULL) || ((hd_ptr)->size != (Size)))) ||     \
        (((len) >= 1) && (((hd_ptr) == NULL) || ((hd_ptr)->aux_prev != NULL) ||        \
                             ((tail_ptr) == NULL) || ((tail_ptr)->aux_next != NULL)))) \
    {                                                                                  \
...
if(((hd_ptr) == NULL) || ((tail_ptr) == NULL) || ((entry_ptr) == NULL) ||           \
        ...
        (((len) == 1) &&                                                            \
            (!(((hd_ptr) == (entry_ptr)) && ((tail_ptr) == (entry_ptr)) &&          \
                ((entry_ptr)->il_next == NULL) && ((entry_ptr)->il_prev == NULL) && \
                ((Size) == (entry_ptr)->size)))))                                   \
    {                                                                               \
...
#define H5C__IL_DLL_PRE_INSERT_SC(entry_ptr, hd_ptr, tail_ptr, len, Size, fv)         \
    \
if(((entry_ptr) == NULL) || ((entry_ptr)->il_next != NULL) ||                         \
        ((entry_ptr)->il_prev != NULL) ||                                             \
        ((((hd_ptr) == NULL) || ((tail_ptr) == NULL)) && ((hd_ptr) != (tail_ptr))) || \
        (((len) == 1) && (((hd_ptr) != (tail_ptr)) || ((Size) <= 0) ||                \
                             ((hd_ptr) == NULL) || ((hd_ptr)->size != (Size)))) ||    \
        (((len) >= 1) && (((hd_ptr) == NULL) || ((hd_ptr)->il_prev != NULL) ||        \
...
if(((((head_ptr) == NULL) || ((tail_ptr) == NULL)) && ((head_ptr) != (tail_ptr))) ||  \
        (((len) == 1) && (((head_ptr) != (tail_ptr)) || ((head_ptr) == NULL) ||       \
                             ((head_ptr)->size != (Size)))) ||                        \
        (((len) >= 1) && (((head_ptr) == NULL) || ((head_ptr)->il_prev != NULL) ||    \
                             ((tail_ptr) == NULL) || ((tail_ptr)->il_next != NULL)))) \
    {                                                                                 \
...
#define H5C__PRE_HT_REMOVE_SC(cache_ptr, entry_ptr)                                    \
    \
if(((cache_ptr) == NULL) || ((cache_ptr)->magic != H5C__H5C_T_MAGIC) ||                \
        ((cache_ptr)->index_len < 1) || ((entry_ptr) == NULL) ||                       \
...
if(((cache_ptr) == NULL) || ((cache_ptr)->magic != H5C__H5C_T_MAGIC) ||                \
        ((entry_ptr) == NULL) || (!H5F_addr_defined((entry_ptr)->addr)) ||             \
        ((entry_ptr)->size <= 0) || ((entry_ptr)->ht_prev != NULL) ||                  \
        ((entry_ptr)->ht_prev != NULL) ||                                              \
        ((cache_ptr)->index_size !=                                                    \
            ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size)) ||        \
        ((cache_ptr)->index_size < ((cache_ptr)->clean_index_size)) ||                 \
...
if(((cache_ptr) == NULL) || ((cache_ptr)->magic != H5C__H5C_T_MAGIC) ||                 \
    ...
    {                                                                                   \
        HGOTO_ERROR(                                                                    \
            H5E_CACHE, H5E_SYSTEM, fail_val, "post successful HT search SC failed")     \
    \
}
...
#define H5C__PRE_HT_ENTRY_SIZE_CHANGE_SC(                                              \
    cache_ptr, old_size, new_size, entry_ptr, was_clean)                               \
    \
if(((cache_ptr) == NULL) || ((cache_ptr)->index_len <= 0) ||                           \
        ((cache_ptr)->index_size <= 0) || ((new_size) <= 0) ||                         \
...
#define H5C__POST_HT_ENTRY_SIZE_CHANGE_SC(cache_ptr, old_size, new_size, entry_ptr)     \
    \
if(((cache_ptr) == NULL) || ((cache_ptr)->index_len <= 0) ||                            \
        ((cache_ptr)->index_size <= 0) || ((new_size) > (cache_ptr)->index_size) ||     \
        ((cache_ptr)->index_size !=                                                     \
            ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size)) ||         \
        ((cache_ptr)->index_size < ((cache_ptr)->clean_index_size)) ||                  \
        ((cache_ptr)->index_size < ((cache_ptr)->dirty_index_size)) ||                  \
...
#define H5C__PRE_HT_UPDATE_FOR_ENTRY_CLEAN_SC(cache_ptr, entry_ptr)                    \
    \
if(((cache_ptr) == NULL) || ((cache_ptr)->magic != H5C__H5C_T_MAGIC) ||                \
        ((cache_ptr)->index_len <= 0) || ((entry_ptr) == NULL) ||                      \
    ...
    {                                                                                  \
        HDassert(FALSE);                                                               \
        HGOTO_ERROR(                                                                   \
            H5E_CACHE, H5E_SYSTEM, FAIL, "pre HT update for entry clean SC failed")    \
    \
}
...
if(((cache_ptr) == NULL) || ((cache_ptr)->magic != H5C__H5C_T_MAGIC) ||                \
    ...
    {                                                                                  \
        HDassert(FALSE);                                                               \
        HGOTO_ERROR(                                                                   \
            H5E_CACHE, H5E_SYSTEM, FAIL, "pre HT update for entry dirty SC failed")    \
    \
}
...
if(((cache_ptr)->index_size !=                                                         \
    ...
    {                                                                                  \
        HDassert(FALSE);                                                               \
        HGOTO_ERROR(                                                                   \
            H5E_CACHE, H5E_SYSTEM, FAIL, "post HT update for entry clean SC failed")   \
    \
}
...
if(((cache_ptr)->index_size !=                                                         \
    ...
    {                                                                                  \
        HDassert(FALSE);                                                               \
        HGOTO_ERROR(                                                                   \
            H5E_CACHE, H5E_SYSTEM, FAIL, "post HT update for entry dirty SC failed")   \
    \
}
...
{                                                                                \
        ...
        H5C__IL_DLL_APPEND((entry_ptr), (cache_ptr)->il_head, (cache_ptr)->il_tail,     \
            (cache_ptr)->il_len, (cache_ptr)->il_size, fail_val)                        \
...
{                                                                                \
        ...
        H5C__IL_DLL_REMOVE((entry_ptr), (cache_ptr)->il_head, (cache_ptr)->il_tail,     \
            (cache_ptr)->il_len, (cache_ptr)->il_size, fail_val)                        \
...
#define H5C__UPDATE_INDEX_FOR_SIZE_CHANGE(                                          \
    cache_ptr, old_size, new_size, entry_ptr, was_clean)                            \
    \
{                                                                            \
        ...
        H5C__DLL_UPDATE_FOR_SIZE_CHANGE(                                            \
            (cache_ptr)->il_len, (cache_ptr)->il_size, (old_size), (new_size))      \
...
{                                                                                 \
        ...
        HDassert(                                                                        \
            (cache_ptr)->slist_ring_len[(entry_ptr)->ring] <= (cache_ptr)->slist_len);   \
        HDassert(                                                                        \
            (cache_ptr)->slist_ring_size[(entry_ptr)->ring] <= (cache_ptr)->slist_size); \
                                                                                         \
        if(H5SL_insert((cache_ptr)->slist_ptr, entry_ptr, &(entry_ptr)->addr) < 0)       \
            HGOTO_ERROR(                                                                 \
                H5E_CACHE, H5E_BADVALUE, (fail_val), "can't insert entry in skip list")  \
                                                                                         \
...
{                                                                                 \
        ...
        if(H5SL_remove((cache_ptr)->slist_ptr, &(entry_ptr)->addr) != (entry_ptr))       \
            HGOTO_ERROR(                                                                 \
                H5E_CACHE, H5E_BADVALUE, FAIL, "can't delete entry from skip list")      \
                                                                                         \
        HDassert((cache_ptr)->slist_len > 0);                                            \
...
{                                                                                 \
        ...
        HDassert((cache_ptr)->slist_len > 0);                                            \
        HDassert(                                                                        \
            ((cache_ptr)->slist_len > 1) || ((cache_ptr)->slist_size == (old_size)));    \
        HDassert((entry_ptr)->ring > H5C_RING_UNDEFINED);                                \
        HDassert((entry_ptr)->ring < H5C_RING_NTYPES);                                   \
        HDassert(                                                                        \
            (cache_ptr)->slist_ring_len[(entry_ptr)->ring] <= (cache_ptr)->slist_len);   \
        ...
        HDassert(                                                                        \
            ((cache_ptr)->slist_len > 1) || ((cache_ptr)->slist_size == (new_size)));    \
    \
        ...
        if(!((entry_ptr)->is_pinned)) {                                           \
            ...
            if((entry_ptr)->is_dirty) {                                           \
                H5C__AUX_DLL_REMOVE((entry_ptr), (cache_ptr)->dLRU_head_ptr,      \
                    (cache_ptr)->dLRU_tail_ptr, (cache_ptr)->dLRU_list_len,       \
...
{                                                                                \
        ...
        if((entry_ptr)->is_pinned) {                                                    \
            ...
            H5C__DLL_PREPEND((entry_ptr), (cache_ptr)->pel_head_ptr,                    \
                (cache_ptr)->pel_tail_ptr, (cache_ptr)->pel_len, (cache_ptr)->pel_size, \
                (fail_val))                                                             \
                                                                                        \
        } else {                                                                        \
                                                                                        \
...
{                                                                                 \
        ...
        if((entry_ptr)->coll_access) {                                                   \
            ...
            H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->coll_list_len,                  \
                (cache_ptr)->coll_list_size, (entry_ptr)->size, (new_size));             \
        }                                                                                \
                                                                                         \
        if((entry_ptr)->is_pinned) {                                                     \
                                                                                         \
            ...
            H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->LRU_list_len,                   \
                (cache_ptr)->LRU_list_size, (entry_ptr)->size, (new_size));              \
                                                                                         \
            ...
            if((entry_ptr)->is_dirty) {                                                  \
                ...
                H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->dLRU_list_len,              \
                    (cache_ptr)->dLRU_list_size, (entry_ptr)->size, (new_size));         \
                                                                                         \
            } else {                                                                     \
                                                                                         \
                H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->cLRU_list_len,              \
                    (cache_ptr)->cLRU_list_size, (entry_ptr)->size, (new_size));         \
            }                                                                            \
                                                                                         \
            /* End modified LRU specific code. */                                        \
        }                                                                                \
...
if(((hd_ptr) == NULL) || ((tail_ptr) == NULL) || ((entry_ptr) == NULL) ||               \
        ...
        (((len) == 1) &&                                                                \
            (!(((hd_ptr) == (entry_ptr)) && ((tail_ptr) == (entry_ptr)) &&              \
                ((entry_ptr)->coll_next == NULL) && ((entry_ptr)->coll_prev == NULL) && \
                ((Size) == (entry_ptr)->size)))))                                       \
    {                                                                                   \
...
if(((((head_ptr) == NULL) || ((tail_ptr) == NULL)) && ((head_ptr) != (tail_ptr))) ||    \
        ...
        (((len) == 1) && (((head_ptr) != (tail_ptr)) || ((Size) <= 0) ||                \
                             ((head_ptr) == NULL) || ((head_ptr)->size != (Size)))) ||  \
        (((len) >= 1) && (((head_ptr) == NULL) || ((head_ptr)->coll_prev != NULL) ||    \
...
#define H5C__COLL_DLL_PRE_INSERT_SC(entry_ptr, hd_ptr, tail_ptr, len, Size, fv)         \
    \
if(((entry_ptr) == NULL) || ((entry_ptr)->coll_next != NULL) ||                         \
        ((entry_ptr)->coll_prev != NULL) ||                                             \
        ((((hd_ptr) == NULL) || ((tail_ptr) == NULL)) && ((hd_ptr) != (tail_ptr))) ||   \
        (((len) == 1) && (((hd_ptr) != (tail_ptr)) || ((Size) <= 0) ||                  \
                             ((hd_ptr) == NULL) || ((hd_ptr)->size != (Size)))) ||      \
        (((len) >= 1) && (((hd_ptr) == NULL) || ((hd_ptr)->coll_prev != NULL) ||        \
                             ((tail_ptr) == NULL) || ((tail_ptr)->coll_next != NULL)))) \
    {                                                                                   \
...
{                                                               \
        ...
        H5C__COLL_DLL_PREPEND((entry_ptr), (cache_ptr)->coll_head_ptr, \
            (cache_ptr)->coll_tail_ptr, (cache_ptr)->coll_list_len,    \

...
#define H5Z_FILTER_RESERVED \
    256 /*filter ids below this value are reserved for library use */
...
typedef H5Z_cb_return_t (
    *H5Z_filter_func_t)(H5Z_filter_t filter, void* buf, size_t buf_size, void* op_data);
 ...
 */
typedef size_t (*H5Z_func_t)(unsigned int flags,
    size_t cd_nelmts,

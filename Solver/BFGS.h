...
*
* The BFGS method is a rank two method which tends to converge faster than the
* conventional Newton--Raphson method. The BFGS method solves the inverse of the stiffness
* matrix only once for each iterative step. But the sparsity is normally lost for the
* inverse matrix. Hence the storage is significantly higher than Newton--Raphson method.
* Hence for large scale problem, in which the RAM is a problem, probably the user shall
...
* The \f$R\f$ is current residual. For brevity, in both terms, the subscript \f$n\f$

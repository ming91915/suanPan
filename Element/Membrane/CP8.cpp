...
int CP8::update_status() {
    ...
    for(const auto& I : int_pt) {
        ...
        trial_stiffness(0, 12) += NX7 * D11NX1D13NY1 + NY7 * D13NX1D33NY1;
        trial_stiffness(0, 13) += NX7 * D13NX1D33NY1 + NY7 * D12NX1D23NY1;
        trial_stiffness(0, 14) += NX8 * D11NX1D13NY1 + NY8 * D13NX1D33NY1;
        trial_stiffness(0, 15) += NX8 * D13NX1D33NY1 + NY8 * D12NX1D23NY1;
        ...
        trial_stiffness(1, 12) += NX7 * D13NX1D12NY1 + NY7 * D33NX1D23NY1;
        trial_stiffness(1, 13) += NX7 * D33NX1D23NY1 + NY7 * D23NX1D22NY1;
        trial_stiffness(1, 14) += NX8 * D13NX1D12NY1 + NY8 * D33NX1D23NY1;
        trial_stiffness(1, 15) += NX8 * D33NX1D23NY1 + NY8 * D23NX1D22NY1;
        ...
        trial_stiffness(2, 12) += NX7 * D11NX2D13NY2 + NY7 * D13NX2D33NY2;
        trial_stiffness(2, 13) += NX7 * D13NX2D33NY2 + NY7 * D12NX2D23NY2;
        trial_stiffness(2, 14) += NX8 * D11NX2D13NY2 + NY8 * D13NX2D33NY2;
        trial_stiffness(2, 15) += NX8 * D13NX2D33NY2 + NY8 * D12NX2D23NY2;
        ...
        trial_stiffness(3, 12) += NX7 * D13NX2D12NY2 + NY7 * D33NX2D23NY2;
        trial_stiffness(3, 13) += NX7 * D33NX2D23NY2 + NY7 * D23NX2D22NY2;
        trial_stiffness(3, 14) += NX8 * D13NX2D12NY2 + NY8 * D33NX2D23NY2;
        trial_stiffness(3, 15) += NX8 * D33NX2D23NY2 + NY8 * D23NX2D22NY2;
        ...
        trial_stiffness(4, 12) += NX7 * D11NX3D13NY3 + NY7 * D13NX3D33NY3;
        trial_stiffness(4, 13) += NX7 * D13NX3D33NY3 + NY7 * D12NX3D23NY3;
        trial_stiffness(4, 14) += NX8 * D11NX3D13NY3 + NY8 * D13NX3D33NY3;
        trial_stiffness(4, 15) += NX8 * D13NX3D33NY3 + NY8 * D12NX3D23NY3;
        ...
        trial_stiffness(5, 12) += NX7 * D13NX3D12NY3 + NY7 * D33NX3D23NY3;
        trial_stiffness(5, 13) += NX7 * D33NX3D23NY3 + NY7 * D23NX3D22NY3;
        trial_stiffness(5, 14) += NX8 * D13NX3D12NY3 + NY8 * D33NX3D23NY3;
        trial_stiffness(5, 15) += NX8 * D33NX3D23NY3 + NY8 * D23NX3D22NY3;
        ...
        trial_stiffness(6, 12) += NX7 * D11NX4D13NY4 + NY7 * D13NX4D33NY4;
        trial_stiffness(6, 13) += NX7 * D13NX4D33NY4 + NY7 * D12NX4D23NY4;
        trial_stiffness(6, 14) += NX8 * D11NX4D13NY4 + NY8 * D13NX4D33NY4;
        trial_stiffness(6, 15) += NX8 * D13NX4D33NY4 + NY8 * D12NX4D23NY4;
        ...
        trial_stiffness(7, 12) += NX7 * D13NX4D12NY4 + NY7 * D33NX4D23NY4;
        trial_stiffness(7, 13) += NX7 * D33NX4D23NY4 + NY7 * D23NX4D22NY4;
        trial_stiffness(7, 14) += NX8 * D13NX4D12NY4 + NY8 * D33NX4D23NY4;
        trial_stiffness(7, 15) += NX8 * D33NX4D23NY4 + NY8 * D23NX4D22NY4;
        ...
        trial_stiffness(8, 12) += NX7 * D11NX5D13NY5 + NY7 * D13NX5D33NY5;
        trial_stiffness(8, 13) += NX7 * D13NX5D33NY5 + NY7 * D12NX5D23NY5;
        trial_stiffness(8, 14) += NX8 * D11NX5D13NY5 + NY8 * D13NX5D33NY5;
        trial_stiffness(8, 15) += NX8 * D13NX5D33NY5 + NY8 * D12NX5D23NY5;
        ...
        trial_stiffness(9, 12) += NX7 * D13NX5D12NY5 + NY7 * D33NX5D23NY5;
        trial_stiffness(9, 13) += NX7 * D33NX5D23NY5 + NY7 * D23NX5D22NY5;
        trial_stiffness(9, 14) += NX8 * D13NX5D12NY5 + NY8 * D33NX5D23NY5;
        trial_stiffness(9, 15) += NX8 * D33NX5D23NY5 + NY8 * D23NX5D22NY5;
        trial_stiffness(10, 10) += NX6 * D11NX6D13NY6 + NY6 * D13NX6D33NY6;
        trial_stiffness(10, 11) += NX6 * D13NX6D33NY6 + NY6 * D12NX6D23NY6;
        trial_stiffness(10, 12) += NX7 * D11NX6D13NY6 + NY7 * D13NX6D33NY6;
        trial_stiffness(10, 13) += NX7 * D13NX6D33NY6 + NY7 * D12NX6D23NY6;
        trial_stiffness(10, 14) += NX8 * D11NX6D13NY6 + NY8 * D13NX6D33NY6;
        trial_stiffness(10, 15) += NX8 * D13NX6D33NY6 + NY8 * D12NX6D23NY6;
        trial_stiffness(11, 11) += NX6 * D33NX6D23NY6 + NY6 * D23NX6D22NY6;
        trial_stiffness(11, 12) += NX7 * D13NX6D12NY6 + NY7 * D33NX6D23NY6;
        trial_stiffness(11, 13) += NX7 * D33NX6D23NY6 + NY7 * D23NX6D22NY6;
        trial_stiffness(11, 14) += NX8 * D13NX6D12NY6 + NY8 * D33NX6D23NY6;
        trial_stiffness(11, 15) += NX8 * D33NX6D23NY6 + NY8 * D23NX6D22NY6;
        trial_stiffness(12, 12) += NX7 * D11NX7D13NY7 + NY7 * D13NX7D33NY7;
        trial_stiffness(12, 13) += NX7 * D13NX7D33NY7 + NY7 * D12NX7D23NY7;
        trial_stiffness(12, 14) += NX8 * D11NX7D13NY7 + NY8 * D13NX7D33NY7;
        trial_stiffness(12, 15) += NX8 * D13NX7D33NY7 + NY8 * D12NX7D23NY7;
        trial_stiffness(13, 13) += NX7 * D33NX7D23NY7 + NY7 * D23NX7D22NY7;
        trial_stiffness(13, 14) += NX8 * D13NX7D12NY7 + NY8 * D33NX7D23NY7;
        trial_stiffness(13, 15) += NX8 * D33NX7D23NY7 + NY8 * D23NX7D22NY7;
        trial_stiffness(14, 14) += NX8 * D11NX8D13NY8 + NY8 * D13NX8D33NY8;
        trial_stiffness(14, 15) += NX8 * D13NX8D33NY8 + NY8 * D12NX8D23NY8;
        trial_stiffness(15, 15) += NX8 * D33NX8D23NY8 + NY8 * D23NX8D22NY8;
        ...
        trial_resistance(12) += NX7 * S1 + NY7 * S3;
        trial_resistance(13) += NX7 * S3 + NY7 * S2;
        trial_resistance(14) += NX8 * S1 + NY8 * S3;
        trial_resistance(15) += NX8 * S3 + NY8 * S2;
    }

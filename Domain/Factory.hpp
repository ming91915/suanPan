...
public:
    ...
    template <typename T1>
    friend shared_ptr<MetaMat<T1>>& get_mass(const shared_ptr<Factory<T1>>&);
    template <typename T1>
    friend shared_ptr<MetaMat<T1>>& get_damping(const shared_ptr<Factory<T1>>&);
    template <typename T1>
    friend shared_ptr<MetaMat<T1>>& get_stiffness(const shared_ptr<Factory<T1>>&);

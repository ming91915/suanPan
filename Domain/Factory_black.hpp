...
template <typename eT, typename T>
const bool& Factory<eT, T>::is_symm() const {
    return symm_mat;
}

template <typename eT, typename T>
const bool& Factory<eT, T>::is_band() const {
    return band_mat;
}

template <typename eT, typename T>
void Factory<eT, T>::set_symm(const bool& B) {
    symm_mat = B;
}

template <typename eT, typename T>
void Factory<eT, T>::set_band(const bool& B) {
    band_mat = B;
}

template <typename eT, typename T>
void Factory<eT, T>::set_dof_number(const unsigned& D) {
    dof_number = D;
}

template <typename eT, typename T>
const unsigned& Factory<eT, T>::get_dof_number() const {
    return dof_number;
}
...
template <typename eT, typename T>
void Factory<eT, T>::set_error(const eT& E) {
    error = E;
}

template <typename eT, typename T>
const eT& Factory<eT, T>::get_error() const {
    return error;
}

template <typename eT, typename T>
const bool& Factory<eT, T>::is_initialized() const {
    return initialized;
}

template <typename eT, typename T>
int Factory<eT, T>::initialize() {
...
template <typename eT, typename T>
void Factory<eT, T>::initialize_load(const unsigned& D) {
    trial_load.zeros(D);
    incre_load.zeros(D);
...
template <typename eT, typename T>
void Factory<eT, T>::initialize_mass(const unsigned& D) {
    if(is_band())
        if(is_symm())
...
template <typename eT, typename T>
void Factory<eT, T>::update_ninja(const Col<eT>& N) {
    ninja = N;
}

template <typename eT, typename T>
void Factory<eT, T>::update_trial_time(const eT& M) {
    trial_time = M;
...
template <typename eT, typename T>
void Factory<eT, T>::update_incre_time(const eT& M) {
    incre_time = M;
...
template <typename eT, typename T>
void Factory<eT, T>::update_current_time(const eT& M) {
    current_time = M;
}
...
template <typename eT, typename T>
void Factory<eT, T>::update_pre_time(const eT& M) {
    pre_time = M;
}

template <typename eT, typename T>
void Factory<eT, T>::update_pre_load(const Col<eT>& L) {
    pre_load = L;
}
...
template <typename eT, typename T>
void Factory<eT, T>::update_mass(const T& M) {
    global_mass = M;
}

template <typename eT, typename T>
void Factory<eT, T>::update_damping(const T& D) {
    global_damping = D;
}

template <typename eT, typename T>
void Factory<eT, T>::update_stiffness(const T& K) {
    global_stiffness = K;
}

template <typename eT, typename T>
const Col<eT>& Factory<eT, T>::get_ninja() const {
    return ninja;
}

template <typename eT, typename T>
const eT& Factory<eT, T>::get_trial_time() const {
    return trial_time;
}

template <typename eT, typename T>
const Col<eT>& Factory<eT, T>::get_trial_load() const {
    return trial_load;
}
...
template <typename eT, typename T>
const eT& Factory<eT, T>::get_incre_time() const {
    return incre_time;
}

template <typename eT, typename T>
const Col<eT>& Factory<eT, T>::get_incre_load() const {
    return incre_load;
}
...
template <typename eT, typename T>
const eT& Factory<eT, T>::get_current_time() const {
    return current_time;
}

template <typename eT, typename T>
const Col<eT>& Factory<eT, T>::get_current_load() const {
    return current_load;
}
...
template <typename eT, typename T>
const eT& Factory<eT, T>::get_pre_time() const {
    return pre_time;
}

template <typename eT, typename T>
const Col<eT>& Factory<eT, T>::get_pre_load() const {
    return pre_load;
}
...
template <typename eT, typename T>
const Col<eT>& Factory<eT, T>::get_pre_velocity() const {
    return pre_velocity;
}
...
template <typename eT, typename T>
const T& Factory<eT, T>::get_mass() const {
    return global_mass;
}

template <typename eT, typename T>
const T& Factory<eT, T>::get_damping() const {
    return global_damping;
}

template <typename eT, typename T>
const T& Factory<eT, T>::get_stiffness() const {
    return global_stiffness;
}

template <typename eT, typename T>
const Col<eT>& Factory<eT, T>::get_eigenvalue() const {
    return eigenvalue;
}

template <typename eT, typename T>
const Mat<eT>& Factory<eT, T>::get_eigenvector() const {
    return eigenvector;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_status() {
    commit_time();
...
template <typename eT, typename T>
void Factory<eT, T>::commit_time() {
    current_time = trial_time;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_load() {
    current_load = trial_load;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_resistance() {
    current_resistance = trial_resistance;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_displacement() {
    current_displacement = trial_displacement;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_velocity() {
    current_velocity = trial_velocity;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_acceleration() {
    current_acceleration = trial_acceleration;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_temperature() {
    current_temperature = trial_temperature;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_pre_status() {
    commit_pre_time();
...
template <typename eT, typename T>
void Factory<eT, T>::commit_pre_time() {
    pre_time = current_time;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_pre_load() {
    pre_load = current_load;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_pre_resistance() {
    pre_resistance = current_resistance;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_pre_displacement() {
    pre_displacement = current_displacement;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_pre_velocity() {
    pre_velocity = current_velocity;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_pre_acceleration() {
    pre_acceleration = current_acceleration;
}

template <typename eT, typename T>
void Factory<eT, T>::commit_pre_temperature() {
    pre_temperature = current_temperature;
}

template <typename eT, typename T>
void Factory<eT, T>::clear_status() {
...
template <typename eT, typename T>
void Factory<eT, T>::clear_resistance() {
...
template <typename eT, typename T>
void Factory<eT, T>::clear_displacement() {
...
template <typename eT, typename T>
void Factory<eT, T>::clear_velocity() {
...
template <typename eT, typename T>
void Factory<eT, T>::clear_acceleration() {
...
template <typename eT, typename T>
void Factory<eT, T>::clear_temperature() {
...
template <typename eT, typename T>
void Factory<eT, T>::reset_status() {
    ninja.zeros();
...
template <typename eT, typename T>
void Factory<eT, T>::reset_time() {
    trial_time = current_time;
    incre_time = 0.;
}

template <typename eT, typename T>
void Factory<eT, T>::reset_load() {
...
template <typename eT, typename T>
void Factory<eT, T>::reset_resistance() {
...
template <typename eT, typename T>
void Factory<eT, T>::reset_displacement() {
...
template <typename eT, typename T>
void Factory<eT, T>::reset_velocity() {
...
template <typename eT, typename T>
void Factory<eT, T>::reset_acceleration() {
...
template <typename eT, typename T>
void Factory<eT, T>::reset_temperature() {
...
template <typename eT, typename T>
void Factory<eT, T>::clear_eigen() {
    eigenvalue.zeros();
    eigenvector.zeros();
}

template <typename eT, typename T>
void Factory<eT, T>::clear_mass() {
    global_mass.zeros();
}

template <typename eT, typename T>
void Factory<eT, T>::clear_damping() {
    global_damping.zeros();
}

template <typename eT, typename T>
void Factory<eT, T>::clear_stiffness() {
    global_stiffness.zeros();
}

template <typename eT, typename T>
void Factory<eT, T>::print() const {
...
template <typename eT, typename T>
Col<eT>& get_ninja(const shared_ptr<Factory<eT, T>>& W) {
    return W->ninja;
}

template <typename eT, typename T>
eT& get_trial_time(const shared_ptr<Factory<eT, T>>& W) {
    return W->trial_time;
}
...
template <typename eT, typename T>
eT& get_incre_time(const shared_ptr<Factory<eT, T>>& W) {
    return W->incre_time;
}
...
template <typename eT, typename T>
eT& get_pre_time(const shared_ptr<Factory<eT, T>>& W) {
    return W->pre_time;
}
...
template <typename eT, typename T>
T& get_mass(const shared_ptr<Factory<eT, T>>& W) {
    return W->global_mass;
}

template <typename eT, typename T>
T& get_damping(const shared_ptr<Factory<eT, T>>& W) {
    return W->global_damping;
}

template <typename eT, typename T>
T& get_stiffness(const shared_ptr<Factory<eT, T>>& W) {
